...
namespace PlayingCard.GamePlay.Model.PlayModels
{
    ...
    public class PlayTable : IPlayTable, IInitializable, IDisposable
    {
        ...
        private readonly ISubscriber<TableStateMessage> tableStateSubscriber;
        private readonly IPublisher<TurnStartMessage> turnStartPublisher;
        private readonly ISubscriber<TurnActionMessage> turnActionSubscriber;
        ...
        private readonly ISubscriber<DrawCardSelectMessage> drawCardSelectSubscriber;
        private readonly ISubscriber<DrawCardsMessage> drawCardsSubscriber;
        ...
        public void Initialize()
        {
            ...
            turnActionSubscriber.Subscribe(TrunAction).AddTo(bagBuilder);
